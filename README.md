# ChainRadar: On-chain event radar with AI-driven protocol anomaly classification Implementation
> Advanced javascript solution leveraging modern architecture patterns and cutting-edge AI technology.

ChainRadar subscribes to every major protocol's event stream, classifies emitted events against a library of known attack signatures, and surfaces novel anomalies for human review.

ChainRadar's key benefits include:
...
```bash
git clone https://github.com/Devnilethegreat/ChainRadar.git
cd ChainRadar
```
...
- **2025-08-15** — Expand test coverage for edge cases
- **2025-08-28** — Expand test coverage for edge cases
- **2025-09-20** — Expand test coverage for edge cases
- **2025-12-17** — Expand test coverage for edge cases
- **2026-01-01** — Expand test coverage for edge cases
